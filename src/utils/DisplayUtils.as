package utils 
{
	...
	public class DisplayUtils 
	{
		...
		//==================================================================================================	
			bmp 			= new Bitmap(displayObjectToBitmapData(displayObject, scaleFactor, smooth));
			bmp				.smoothing = smooth;
			return bmp;
		}
		...
		public static function getButtonFromSimpleButtonClass(classRef:Class, sf:Number = 1):Button {
		...
		public static function textureFromClass(classRef:Class, sf:Number):Texture {
			...
			var displayObject:DisplayObject = new classRef() as DisplayObject;
			var mtr:Matrix = displayObject.transform.matrix;
